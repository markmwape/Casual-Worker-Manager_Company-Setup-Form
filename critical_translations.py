"""
Manual translations for critical 268 strings
High-quality translations for buttons, labels, and messages
"""
...
if __name__ == '__main__':
    print(f"✅ Critical translations loaded: {len(CRITICAL_TRANSLATIONS)} strings")
    for lang in ['fr', 'sw', 'pt', 'es', 'tr', 'hi', 'zh', 'ar', 'vi']:
        translated_count = sum(1 for trans_dict in CRITICAL_TRANSLATIONS.values() if lang in trans_dict)
        print(f"   {lang.upper()}: {translated_count} strings translated")
